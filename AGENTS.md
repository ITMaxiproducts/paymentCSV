...
- [Local development and verification](docs/operations/local-development.md): Runtime requirements, environment variables, local server, verification commands, fixtures, and troubleshooting.
